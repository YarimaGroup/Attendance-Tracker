...
class RecordTile extends StatelessWidget {
  ...
  const RecordTile({super.key, required this.doc, required this.dfDate, required this.dfTime, this.isGrouped = false, this.onTap});
      ...
      leading: thumb == null
          ...
          : ClipRRect(
              ...
              child: Container(
                width: 48,
                height: 48,
                decoration: BoxDecoration(border: Border.all(color: color.withOpacity(0.3), width: 2), borderRadius: BorderRadius.circular(8)),
      ...
      title: Row(children: [
        ...
        Container(
          ...
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text('Clock $type', style: TextStyle(color: color, fontSize: 12, fontWeight: FontWeight.w500)),
          ]),
        ),
        if (isGrouped) const Spacer(),
        if (isGrouped)
          Text(dfTime.format(time), style: Theme.of(context).textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w500)),
      ]),
      subtitle: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          ...
          if (email != null && !isGrouped) ...[
            ...
            Flexible(child: Text(email, overflow: TextOverflow.ellipsis, style: TextStyle(color: Theme.of(context).colorScheme.outline))),
          ],
        ]),
        if (address != null && address.isNotEmpty) ...[
          ...
          Row(children: [
            ...
            const SizedBox(width: 4),
            Expanded(child: Text(address, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(color: Theme.of(context).colorScheme.outline))),
          ]),
        ],
      ]),
