              ...
              children: [
                _tile(
                  ...
                  value: firstClockIn != null
                      ? DateFormat('hh:mm a').format(firstClockIn.time)
                      : '--:--',
                ),
                _divider(),
                _tile(
                  ...
                  color: Colors.orange,
                  label: 'Clock Out',
                  value: lastClockOut != null
                      ? DateFormat('hh:mm a').format(lastClockOut.time)
                      : '--:--',
                ),
                _divider(),
                _tile(
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: _chip(
                    'Clock Outs: ',
                    clockOutEvents.length.toString(),
                    Colors.orange,
                  ),
                ),
              ],
